...
const ServicesGrid = () => {
  const services = [
    ...
    {
      icon: "/Illustration-Vector-of-construction-icon-Graphics-13074115-1.jpg",
    ...
    {
      icon: "/real_estate_property_building_occupation_job_worker_builder_contractor_construction_icon_219086.png",
      title: "Construction",
